...
function PopUpEditHabit({
  ...
  const onSubmitFunction = (data) => {
    ...
    filteredProducts.find((item) => item.id === idHabit).category =
      data.category;
    filteredProducts.find((item) => item.id === idHabit).frequency =
      data.frequency;
    filteredProducts.find((item) => item.id === idHabit).difficulty =
      data.difficulty;
